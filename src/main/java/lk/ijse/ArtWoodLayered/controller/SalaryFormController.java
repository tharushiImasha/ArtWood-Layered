...
import lk.ijse.ArtWoodLayered.dto.tm.OtherSalaryTm;
...
public class SalaryFormController {
    ...
    OtherEmployeeSalaryBO otherEmployeeSalaryBO = (OtherEmployeeSalaryBO) BOFactory.getBoFactory().getBoo(BOFactory.BoTypes.OTHER_SALARY);
    ...
    private void generateNextSalaryId() {
        try {
            String orderId = otherEmployeeSalaryBO.generateNextSalaryId();
    ...
    private void loadAllUsers() {
        try {
            List<OtherSalaryDto> dtoList = otherEmployeeSalaryBO.getAllSalary();
    ...
    private void deleteSalary(String id) {
        try {
            boolean isDeleted = otherEmployeeSalaryBO.deleteSalary(id);
    ...
    void btnPayOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        boolean isSalarySaved = otherEmployeeSalaryBO.saveSalary(emp_id, amount);

        if (isSalarySaved) {
            boolean isFinance = financeBO.reduceFinanceOtherSalary(pay_method, amount);
    ...
    void cmbIdOnAction(ActionEvent event) throws SQLException {
        ...
        String job_role = editProfileBO.getJob(emp_id);
    ...
    void btnUpdateOnAction(ActionEvent event) {
        ...
        try {
            boolean isUpdated = otherEmployeeSalaryBO.updateSalary(dto);
